...
\label{ssec:baseline}
\placeholder{[To be completed. Key content: ResNet-50 FPN backbone, RPN anchor design from EDA (108px median cell), class-weighted head, training protocol.]}

\subsection{Evaluation Metrics}
\label{ssec:metrics}
\placeholder{[To be completed. Key content: mAP@0.5, mAP@{[0.5:0.95]}, per-class AP for each of the 6 classes, dense-region recall definition (images with $>$100 boxes), Dice for Stage 1 segmentation quality.]}
